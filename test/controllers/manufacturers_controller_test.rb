...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post manufacturers_url, params: { manufacturer: { name: @manufacturer.name, products_id: @manufacturer.products_id } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { name: @manufacturer.name, products_id: @manufacturer.products_id } }
